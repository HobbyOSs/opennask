...
class Day06Suite : public ::testing::Test {
protected:
    // 試験開始時に一回だけ実行
    Day06Suite() {
...
_asm_inthandler2c:
    ...
    expected.insert(expected.end(), {
            0x4C, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5E, 0x01, 0x00, 0x00, 0x1C, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00
        });
    // COFFの各種section
    expected.insert(expected.end(), {
            0x2E, 0x74, 0x65, 0x78, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xB4, 0x00, 0x00, 0x00, 0x8C, 0x00, 0x00, 0x00, 0x40, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    expected.insert(expected.end(), {
            ...
            0x8B, 0x44, 0x24, 0x04, 0x66, 0x89, 0x44, 0x24, 0x06, 0x0F, 0x01, 0x5C, 0x24, 0x06, 0xC3, 0x06,
            0x1E, 0x60, 0x89, 0xE0, 0x50, 0x66, 0x8C, 0xD0, 0x8E, 0xD8, 0x8E, 0xC0, 0xE8, 0x00, 0x00, 0x00,
            0x00, 0x58, 0x61, 0x1F, 0x07, 0xCF, 0x06, 0x1E, 0x60, 0x89, 0xE0, 0x50, 0x66, 0x8C, 0xD0, 0x8E,
            0xD8, 0x8E, 0xC0, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x58, 0x61, 0x1F, 0x07, 0xCF, 0x06, 0x1E, 0x60,
    ...
    // coff relocations
    expected.insert(expected.end(), {
            0x7D, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x14, 0x00, 0x94, 0x00, 0x00, 0x00, 0x09, 0x00,
            0x00, 0x00, 0x14, 0x00, 0xAB, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x14, 0x00
        }); // coff relocations
    ...
    expected.insert(expected.end(), {
            ...
            0x03, 0x01, 0xB4, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00
        }); // .text
    expected.insert(expected.end(), {
    ...
    expected.insert(expected.end(), {
            ...
            0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6C, 0x00, 0x00, 0x00, 0x86, 0x00, 0x00, 0x00,
            0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x00, 0x00, 0x00, 0x9D, 0x00,
            0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0xBA, 0x00, 0x00, 0x00, 0x5F, 0x69, 0x6F, 0x5F,
            ...
            
        }); // シンボル情報
