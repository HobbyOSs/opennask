...
;    	RET
    ...
    expected.insert(expected.end(), {
            ...
            0x8e, 0x00, 0x00, 0x00, // pointerToSymbolTable (シンボルテーブルへのオフセット; 後で計算される)
            0x09, 0x00, 0x00, 0x00, // numberOfSymbols (シンボルの数)
    ...
    expected.insert(expected.end(), {
            0x2e, 0x62, 0x73, 0x73, 0x00, 0x00, 0x00, 0x00, // .bss
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
    ...
    expected.insert(expected.end(), {
            0x2e, 0x66, 0x69, 0x6c, 0x65, 0x00, 0x00, 0x00, // .file
            0x00, 0x00, 0x00, 0x00, 0xfe, 0xff, 0x00, 0x00,
            0x67, 0x01, 0x6e, 0x61, 0x73, 0x6b, 0x66, 0x75,
            0x6e, 0x63, 0x2e, 0x6e, 0x61, 0x73, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00 // "naskfunc.nas"
        });
    expected.insert(expected.end(), {
            0x2e, 0x74, 0x65, 0x78, 0x74, 0x00, 0x00, 0x00, // .text
