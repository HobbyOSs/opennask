...
void Pass1Strategy::visitMnemonicStmt(MnemonicStmt *mnemonic_stmt){
    ...
    funcs_type funcs {
        ...
        // x86命令(引数なし)
        std::make_pair("OpcodesAAA", std::bind(&Pass1Strategy::processCalc<Inst::kIdAaa, 1>, this)),
        std::make_pair("OpcodesAAS", std::bind(&Pass1Strategy::processCalc<Inst::kIdAas, 1>, this)),
        std::make_pair("OpcodesCBW", std::bind(&Pass1Strategy::processCalc<Inst::kIdCbw, 1>, this)),
        std::make_pair("OpcodesCDQ", std::bind(&Pass1Strategy::processCalc<Inst::kIdCdq, 1>, this)),
        std::make_pair("OpcodesCLC", std::bind(&Pass1Strategy::processCalc<Inst::kIdClc, 1>, this)),
        std::make_pair("OpcodesCLD", std::bind(&Pass1Strategy::processCalc<Inst::kIdCld, 1>, this)),
        std::make_pair("OpcodesCLI", std::bind(&Pass1Strategy::processCalc<Inst::kIdCli, 1>, this)),
        std::make_pair("OpcodesCLTS", std::bind(&Pass1Strategy::processCalc<Inst::kIdClts, 2>, this)),
        std::make_pair("OpcodesCMC", std::bind(&Pass1Strategy::processCalc<Inst::kIdCmc, 1>, this)),
        //std::make_pair("OpcodesCMPSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdCmpsb, 1>, this)),
        //std::make_pair("OpcodesCMPSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdCmpsd, 1>, this)),
        //std::make_pair("OpcodesCMPSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdCmpsw, 1>, this)),
        std::make_pair("OpcodesCWD", std::bind(&Pass1Strategy::processCalc<Inst::kIdCwd, 1>, this)),
        std::make_pair("OpcodesCWDE", std::bind(&Pass1Strategy::processCalc<Inst::kIdCwde, 1>, this)),
        std::make_pair("OpcodesDAA", std::bind(&Pass1Strategy::processCalc<Inst::kIdDaa, 1>, this)),
        std::make_pair("OpcodesDAS", std::bind(&Pass1Strategy::processCalc<Inst::kIdDas, 1>, this)),
        std::make_pair("OpcodesF2XM1", std::bind(&Pass1Strategy::processCalc<Inst::kIdF2xm1, 2>, this)),
        std::make_pair("OpcodesFABS", std::bind(&Pass1Strategy::processCalc<Inst::kIdFabs, 2>, this)),
        std::make_pair("OpcodesFCHS", std::bind(&Pass1Strategy::processCalc<Inst::kIdFchs, 2>, this)),
        std::make_pair("OpcodesFCLEX", std::bind(&Pass1Strategy::processCalc<Inst::kIdFclex, 3>, this)),
        std::make_pair("OpcodesFCOMPP", std::bind(&Pass1Strategy::processCalc<Inst::kIdFcompp, 2>, this)),
        std::make_pair("OpcodesFCOS", std::bind(&Pass1Strategy::processCalc<Inst::kIdFcos, 2>, this)),
        std::make_pair("OpcodesFDECSTP", std::bind(&Pass1Strategy::processCalc<Inst::kIdFdecstp, 2>, this)),
        //std::make_pair("OpcodesFDISI", std::bind(&Pass1Strategy::processCalc<Inst::kIdFdisi, 1>, this)),
        //std::make_pair("OpcodesFENI", std::bind(&Pass1Strategy::processCalc<Inst::kIdFeni, 1>, this)),
        std::make_pair("OpcodesFINCSTP", std::bind(&Pass1Strategy::processCalc<Inst::kIdFincstp, 2>, this)),
        std::make_pair("OpcodesFINIT", std::bind(&Pass1Strategy::processCalc<Inst::kIdFinit, 3>, this)),
        std::make_pair("OpcodesFLD1", std::bind(&Pass1Strategy::processCalc<Inst::kIdFld1, 2>, this)),
        std::make_pair("OpcodesFLDL2E", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldl2e, 2>, this)),
        std::make_pair("OpcodesFLDL2T", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldl2t, 2>, this)),
        std::make_pair("OpcodesFLDLG2", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldlg2, 2>, this)),
        std::make_pair("OpcodesFLDLN2", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldln2, 2>, this)),
        std::make_pair("OpcodesFLDPI", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldpi, 2>, this)),
        std::make_pair("OpcodesFLDZ", std::bind(&Pass1Strategy::processCalc<Inst::kIdFldz, 2>, this)),
        std::make_pair("OpcodesFNCLEX", std::bind(&Pass1Strategy::processCalc<Inst::kIdFnclex, 2>, this)),
        //std::make_pair("OpcodesFNDISI", std::bind(&Pass1Strategy::processCalc<Inst::kIdFndisi, 1>, this)),
        //std::make_pair("OpcodesFNENI", std::bind(&Pass1Strategy::processCalc<Inst::kIdFneni, 1>, this)),
        std::make_pair("OpcodesFNINIT", std::bind(&Pass1Strategy::processCalc<Inst::kIdFninit, 2>, this)),
        std::make_pair("OpcodesFNOP", std::bind(&Pass1Strategy::processCalc<Inst::kIdFnop, 2>, this)),
        std::make_pair("OpcodesFPATAN", std::bind(&Pass1Strategy::processCalc<Inst::kIdFpatan, 2>, this)),
        std::make_pair("OpcodesFPTAN", std::bind(&Pass1Strategy::processCalc<Inst::kIdFptan, 2>, this)),
        std::make_pair("OpcodesFPREM", std::bind(&Pass1Strategy::processCalc<Inst::kIdFprem, 2>, this)),
        std::make_pair("OpcodesFPREM1", std::bind(&Pass1Strategy::processCalc<Inst::kIdFprem1, 2>, this)),
        std::make_pair("OpcodesFRNDINT", std::bind(&Pass1Strategy::processCalc<Inst::kIdFrndint, 2>, this)),
        std::make_pair("OpcodesFSCALE", std::bind(&Pass1Strategy::processCalc<Inst::kIdFscale, 2>, this)),
        //std::make_pair("OpcodesFSETPM", std::bind(&Pass1Strategy::processCalc<Inst::kIdFsetpm, 1>, this)),
        std::make_pair("OpcodesFSIN", std::bind(&Pass1Strategy::processCalc<Inst::kIdFsin, 2>, this)),
        std::make_pair("OpcodesFSINCOS", std::bind(&Pass1Strategy::processCalc<Inst::kIdFsincos, 2>, this)),
        std::make_pair("OpcodesFSQRT", std::bind(&Pass1Strategy::processCalc<Inst::kIdFsqrt, 2>, this)),
        std::make_pair("OpcodesFTST", std::bind(&Pass1Strategy::processCalc<Inst::kIdFtst, 2>, this)),
        std::make_pair("OpcodesFUCOMPP", std::bind(&Pass1Strategy::processCalc<Inst::kIdFucompp, 2>, this)),
        std::make_pair("OpcodesFXAM", std::bind(&Pass1Strategy::processCalc<Inst::kIdFxam, 2>, this)),
        std::make_pair("OpcodesFXTRACT", std::bind(&Pass1Strategy::processCalc<Inst::kIdFxtract, 2>, this)),
        std::make_pair("OpcodesFYL2X", std::bind(&Pass1Strategy::processCalc<Inst::kIdFyl2x, 2>, this)),
        std::make_pair("OpcodesFYL2XP1", std::bind(&Pass1Strategy::processCalc<Inst::kIdFyl2xp1, 2>, this)),
        std::make_pair("OpcodesHLT", std::bind(&Pass1Strategy::processCalc<Inst::kIdHlt, 1>, this)),
        //std::make_pair("OpcodesINSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdInsb, 1>, this)),
        //std::make_pair("OpcodesINSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdInsd, 1>, this)),
        //std::make_pair("OpcodesINSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdInsw, 1>, this)),
        std::make_pair("OpcodesINT3", std::bind(&Pass1Strategy::processCalc<Inst::kIdInt3, 1>, this)),
        std::make_pair("OpcodesINTO", std::bind(&Pass1Strategy::processCalc<Inst::kIdInto, 1>, this)),
        std::make_pair("OpcodesINVD", std::bind(&Pass1Strategy::processCalc<Inst::kIdInvd, 2>, this)),
        std::make_pair("OpcodesIRET", std::bind(&Pass1Strategy::processCalc<Inst::kIdIret, 1>, this)),
        std::make_pair("OpcodesIRETD", std::bind(&Pass1Strategy::processCalc<Inst::kIdIretd, 1>, this)),
        //std::make_pair("OpcodesIRETW", std::bind(&Pass1Strategy::processCalc<Inst::kIdIretw, 1>, this)),
        std::make_pair("OpcodesLAHF", std::bind(&Pass1Strategy::processCalc<Inst::kIdLahf, 1>, this)),
        std::make_pair("OpcodesLEAVE", std::bind(&Pass1Strategy::processCalc<Inst::kIdLeave, 1>, this)),
        //std::make_pair("OpcodesLODSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdLodsb, 1>, this)),
        //std::make_pair("OpcodesLODSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdLodsd, 1>, this)),
        //std::make_pair("OpcodesLODSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdLodsw, 1>, this)),
        //std::make_pair("OpcodesMOVSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdMovsb, 1>, this)),
        std::make_pair("OpcodesMOVSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdMovsd, 1>, this)),
        //std::make_pair("OpcodesMOVSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdMovsw, 1>, this)),
        std::make_pair("OpcodesNOP", std::bind(&Pass1Strategy::processCalc<Inst::kIdNop, 1>, this)),
        //std::make_pair("OpcodesOUTSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdOutsb, 1>, this)),
        //std::make_pair("OpcodesOUTSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdOutsd, 1>, this)),
        //std::make_pair("OpcodesOUTSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdOutsw, 1>, this)),
        std::make_pair("OpcodesPOPA", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopa, 1>, this)),
        std::make_pair("OpcodesPOPAD", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopad, 1>, this)),
        //std::make_pair("OpcodesPOPAW", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopaw, 1>, this)),
        std::make_pair("OpcodesPOPF", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopf, 1>, this)),
        std::make_pair("OpcodesPOPFD", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopfd, 1>, this)),
        //std::make_pair("OpcodesPOPFW", std::bind(&Pass1Strategy::processCalc<Inst::kIdPopfw, 1>, this)),
        std::make_pair("OpcodesPUSHA", std::bind(&Pass1Strategy::processCalc<Inst::kIdPusha, 1>, this)),
        std::make_pair("OpcodesPUSHAD", std::bind(&Pass1Strategy::processCalc<Inst::kIdPushad, 1>, this)),
        //std::make_pair("OpcodesPUSHAW", std::bind(&Pass1Strategy::processCalc<Inst::kIdPushaw, 1>, this)),
        std::make_pair("OpcodesPUSHF", std::bind(&Pass1Strategy::processCalc<Inst::kIdPushf, 1>, this)),
        std::make_pair("OpcodesPUSHFD", std::bind(&Pass1Strategy::processCalc<Inst::kIdPushfd, 1>, this)),
        //std::make_pair("OpcodesPUSHFW", std::bind(&Pass1Strategy::processCalc<Inst::kIdPushfw, 1>, this)),
        std::make_pair("OpcodesSAHF", std::bind(&Pass1Strategy::processCalc<Inst::kIdSahf, 1>, this)),
        //std::make_pair("OpcodesSCASB", std::bind(&Pass1Strategy::processCalc<Inst::kIdScasb, 1>, this)),
        //std::make_pair("OpcodesSCASD", std::bind(&Pass1Strategy::processCalc<Inst::kIdScasd, 1>, this)),
        //std::make_pair("OpcodesSCASW", std::bind(&Pass1Strategy::processCalc<Inst::kIdScasw, 1>, this)),
        std::make_pair("OpcodesSTC", std::bind(&Pass1Strategy::processCalc<Inst::kIdStc, 1>, this)),
        std::make_pair("OpcodesSTD", std::bind(&Pass1Strategy::processCalc<Inst::kIdStd, 1>, this)),
        std::make_pair("OpcodesSTI", std::bind(&Pass1Strategy::processCalc<Inst::kIdSti, 1>, this)),
        //std::make_pair("OpcodesSTOSB", std::bind(&Pass1Strategy::processCalc<Inst::kIdStosb, 1>, this)),
        //std::make_pair("OpcodesSTOSD", std::bind(&Pass1Strategy::processCalc<Inst::kIdStosd, 1>, this)),
        //std::make_pair("OpcodesSTOSW", std::bind(&Pass1Strategy::processCalc<Inst::kIdStosw, 1>, this)),
