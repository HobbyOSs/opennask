...
void Pass1Strategy::define_funcs() {
    this->funcs = {
        ...
        // x86命令(引数あり)
        std::make_pair("OpcodesADC", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdAdc>, this, _1)),
        std::make_pair("OpcodesADD", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdAdd>, this, _1)),
        std::make_pair("OpcodesAND", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdAnd>, this, _1)),
        std::make_pair("OpcodesCALL", std::bind(&Pass1Strategy::processCALL, this, _1)),
        std::make_pair("OpcodesCMP", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdCmp>, this, _1)),
        ...
        std::make_pair("OpcodesOR", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdOr>, this, _1)),
        ...
        std::make_pair("OpcodesSBB", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdSbb>, this, _1)),
        std::make_pair("OpcodesSUB", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdSub>, this, _1)),
        std::make_pair("OpcodesXOR", std::bind(&Pass1Strategy::processCalcAdd<asmjit::x86::Inst::kIdXor>, this, _1))
    };
}
