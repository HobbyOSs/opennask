...
#line 160 "parser.cc"
  ...
  // by_kind.
  NaskParser::by_kind::by_kind ()
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  NaskParser::by_kind::by_kind (by_kind&& that)
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  NaskParser::by_kind::by_kind (const by_kind& that)
    : kind_ (that.kind_)
  {}

  NaskParser::by_kind::by_kind (token_kind_type t)
  ...
  bool
  NaskParser::yy_pact_value_is_default_ (int yyvalue)
  {
    return yyvalue == yypact_ninf_;
  }

  bool
  NaskParser::yy_table_value_is_error_ (int yyvalue)
  {
...
#line 435 "nask.yy"
                        { yylhs.value.as < std::shared_ptr<Exp> > () = std::make_shared<IndirectAddrExp>(yystack_[1].value.as < std::shared_ptr<Exp> > ()); yylhs.value.as < std::shared_ptr<Exp> > ()->line_number = yylhs.location.begin.line; yylhs.value.as < std::shared_ptr<Exp> > ()->char_number = yylhs.location.begin.column; driver.exp_ = yylhs.value.as < std::shared_ptr<Exp> > (); }
#line 1097 "parser.cc"
    break;
...
#line 3135 "parser.cc"
  ...
  const short NaskParser::yypact_ninf_ = -320;

  const signed char NaskParser::yytable_ninf_ = -19;
  ...
  NaskParser::yyrline_[] =
  {
       0,   414,   414,   416,   417,   419,   420,   421,   422,   423,
     425,   426,   428,   430,   431,   432,   433,   434,   435,   436,
