...
class PrintAbsyn : public Visitor
{
 ...
 public:
  ...
  void visitPreOpExp(PreOpExp *p);
  void visitImmExp(ImmExp *p);
  void visitLabel(Label *p); /* abstract class */
  ...
  void visitSReg(SReg *p); /* abstract class */
  void visitSRegCS(SRegCS *p);
  void visitSRegDS(SRegDS *p);
  void visitSRegES(SRegES *p);
  void visitSRegSS(SRegSS *p);
  void visitSRegFS(SRegFS *p);
  void visitSRegGS(SRegGS *p);
  ...
  void visitOpcodeNoParam(OpcodeNoParam *p); /* abstract class */
