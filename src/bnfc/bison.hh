...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    _KW_AAM = 268,                 // _KW_AAM
    _KW_AAS = 269,                 // _KW_AAS
    _KW_ABSOLUTE = 270,            // _KW_ABSOLUTE
    _KW_ADC = 271,                 // _KW_ADC
    _KW_ADD = 272,                 // _KW_ADD
    _KW_ALIGN = 273,               // _KW_ALIGN
    _KW_ALIGNB = 274,              // _KW_ALIGNB
    _KW_AND = 275,                 // _KW_AND
    _KW_ARPL = 276,                // _KW_ARPL
    _KW_BITS = 277,                // _KW_BITS
    _KW_BOUND = 278,               // _KW_BOUND
    _KW_BSF = 279,                 // _KW_BSF
    _KW_BSR = 280,                 // _KW_BSR
    _KW_BSWAP = 281,               // _KW_BSWAP
    _KW_BT = 282,                  // _KW_BT
    _KW_BTC = 283,                 // _KW_BTC
    _KW_BTR = 284,                 // _KW_BTR
    _KW_BTS = 285,                 // _KW_BTS
    _KW_BYTE = 286,                // _KW_BYTE
    _KW_CALL = 287,                // _KW_CALL
    _KW_CBW = 288,                 // _KW_CBW
    _KW_CDQ = 289,                 // _KW_CDQ
    _KW_CLC = 290,                 // _KW_CLC
    _KW_CLD = 291,                 // _KW_CLD
    _KW_CLI = 292,                 // _KW_CLI
    _KW_CLTS = 293,                // _KW_CLTS
    _KW_CMC = 294,                 // _KW_CMC
    _KW_CMP = 295,                 // _KW_CMP
    _KW_CMPSB = 296,               // _KW_CMPSB
    _KW_CMPSD = 297,               // _KW_CMPSD
    _KW_CMPSW = 298,               // _KW_CMPSW
    _KW_CMPXCHG = 299,             // _KW_CMPXCHG
    _KW_CPUID = 300,               // _KW_CPUID
    _KW_CWD = 301,                 // _KW_CWD
    _KW_CWDE = 302,                // _KW_CWDE
    _KW_DAA = 303,                 // _KW_DAA
    _KW_DAS = 304,                 // _KW_DAS
    _KW_DB = 305,                  // _KW_DB
    _KW_DD = 306,                  // _KW_DD
    ...
    _KW_DT = 310,                  // _KW_DT
    _KW_DW = 311,                  // _KW_DW
    _KW_DWORD = 312,               // _KW_DWORD
    _KW_END = 313,                 // _KW_END
    _KW_ENTER = 314,               // _KW_ENTER
    _KW_EQU = 315,                 // _KW_EQU
    _KW_EXTERN = 316,              // _KW_EXTERN
    _KW_F2XM1 = 317,               // _KW_F2XM1
    _KW_FABS = 318,                // _KW_FABS
    _KW_FADD = 319,                // _KW_FADD
    _KW_FADDP = 320,               // _KW_FADDP
    _KW_FBLD = 321,                // _KW_FBLD
    _KW_FBSTP = 322,               // _KW_FBSTP
    _KW_FCHS = 323,                // _KW_FCHS
    _KW_FCLEX = 324,               // _KW_FCLEX
    _KW_FCOM = 325,                // _KW_FCOM
    _KW_FCOMP = 326,               // _KW_FCOMP
    _KW_FCOMPP = 327,              // _KW_FCOMPP
    _KW_FCOS = 328,                // _KW_FCOS
    _KW_FDECSTP = 329,             // _KW_FDECSTP
    _KW_FDISI = 330,               // _KW_FDISI
    _KW_FDIV = 331,                // _KW_FDIV
    _KW_FDIVP = 332,               // _KW_FDIVP
    _KW_FDIVR = 333,               // _KW_FDIVR
    _KW_FDIVRP = 334,              // _KW_FDIVRP
    _KW_FENI = 335,                // _KW_FENI
    _KW_FFREE = 336,               // _KW_FFREE
    _KW_FIADD = 337,               // _KW_FIADD
    _KW_FICOM = 338,               // _KW_FICOM
    _KW_FICOMP = 339,              // _KW_FICOMP
    _KW_FIDIV = 340,               // _KW_FIDIV
    _KW_FIDIVR = 341,              // _KW_FIDIVR
    _KW_FILD = 342,                // _KW_FILD
    _KW_FILE = 343,                // _KW_FILE
    _KW_FIMUL = 344,               // _KW_FIMUL
    _KW_FINCSTP = 345,             // _KW_FINCSTP
    _KW_FINIT = 346,               // _KW_FINIT
    _KW_FIST = 347,                // _KW_FIST
    _KW_FISTP = 348,               // _KW_FISTP
    _KW_FISUB = 349,               // _KW_FISUB
    _KW_FISUBR = 350,              // _KW_FISUBR
    _KW_FLD = 351,                 // _KW_FLD
    _KW_FLD1 = 352,                // _KW_FLD1
    _KW_FLDCW = 353,               // _KW_FLDCW
    _KW_FLDENV = 354,              // _KW_FLDENV
    _KW_FLDL2E = 355,              // _KW_FLDL2E
    _KW_FLDL2T = 356,              // _KW_FLDL2T
    _KW_FLDLG2 = 357,              // _KW_FLDLG2
    _KW_FLDLN2 = 358,              // _KW_FLDLN2
    _KW_FLDPI = 359,               // _KW_FLDPI
    _KW_FLDZ = 360,                // _KW_FLDZ
    _KW_FMUL = 361,                // _KW_FMUL
    _KW_FMULP = 362,               // _KW_FMULP
    _KW_FNCLEX = 363,              // _KW_FNCLEX
    _KW_FNDISI = 364,              // _KW_FNDISI
    _KW_FNENI = 365,               // _KW_FNENI
    _KW_FNINIT = 366,              // _KW_FNINIT
    _KW_FNOP = 367,                // _KW_FNOP
    _KW_FNSAVE = 368,              // _KW_FNSAVE
    _KW_FNSTCW = 369,              // _KW_FNSTCW
    _KW_FNSTENV = 370,             // _KW_FNSTENV
    _KW_FNSTSW = 371,              // _KW_FNSTSW
    _KW_FORMAT = 372,              // _KW_FORMAT
    _KW_FPATAN = 373,              // _KW_FPATAN
    _KW_FPREM = 374,               // _KW_FPREM
    _KW_FPREM1 = 375,              // _KW_FPREM1
    _KW_FPTAN = 376,               // _KW_FPTAN
    _KW_FRNDINT = 377,             // _KW_FRNDINT
    _KW_FRSTOR = 378,              // _KW_FRSTOR
    _KW_FSAVE = 379,               // _KW_FSAVE
    _KW_FSCALE = 380,              // _KW_FSCALE
    _KW_FSETPM = 381,              // _KW_FSETPM
    _KW_FSIN = 382,                // _KW_FSIN
    _KW_FSINCOS = 383,             // _KW_FSINCOS
    _KW_FSQRT = 384,               // _KW_FSQRT
    _KW_FST = 385,                 // _KW_FST
    _KW_FSTCW = 386,               // _KW_FSTCW
    _KW_FSTENV = 387,              // _KW_FSTENV
    _KW_FSTP = 388,                // _KW_FSTP
    _KW_FSTSW = 389,               // _KW_FSTSW
    _KW_FSUB = 390,                // _KW_FSUB
    _KW_FSUBP = 391,               // _KW_FSUBP
    _KW_FSUBR = 392,               // _KW_FSUBR
    _KW_FSUBRP = 393,              // _KW_FSUBRP
    _KW_FTST = 394,                // _KW_FTST
    _KW_FUCOM = 395,               // _KW_FUCOM
    _KW_FUCOMP = 396,              // _KW_FUCOMP
    _KW_FUCOMPP = 397,             // _KW_FUCOMPP
    _KW_FXAM = 398,                // _KW_FXAM
    _KW_FXCH = 399,                // _KW_FXCH
    _KW_FXTRACT = 400,             // _KW_FXTRACT
    _KW_FYL2X = 401,               // _KW_FYL2X
    _KW_FYL2XP1 = 402,             // _KW_FYL2XP1
    _KW_HLT = 403,                 // _KW_HLT
    _KW_IDIV = 404,                // _KW_IDIV
    _KW_IMUL = 405,                // _KW_IMUL
    _KW_IN = 406,                  // _KW_IN
    _KW_INC = 407,                 // _KW_INC
    _KW_INCO = 408,                // _KW_INCO
    _KW_INSB = 409,                // _KW_INSB
    _KW_INSD = 410,                // _KW_INSD
    _KW_INSTRSET = 411,            // _KW_INSTRSET
    _KW_INSW = 412,                // _KW_INSW
    _KW_INT = 413,                 // _KW_INT
    _KW_INT3 = 414,                // _KW_INT3
    _KW_INTO = 415,                // _KW_INTO
    _KW_INVD = 416,                // _KW_INVD
    _KW_INVLPG = 417,              // _KW_INVLPG
    _KW_IRET = 418,                // _KW_IRET
    _KW_IRETD = 419,               // _KW_IRETD
    _KW_IRETW = 420,               // _KW_IRETW
    _KW_JA = 421,                  // _KW_JA
    _KW_JAE = 422,                 // _KW_JAE
    _KW_JB = 423,                  // _KW_JB
    _KW_JBE = 424,                 // _KW_JBE
    _KW_JC = 425,                  // _KW_JC
    _KW_JCXZ = 426,                // _KW_JCXZ
    _KW_JE = 427,                  // _KW_JE
    _KW_JECXZ = 428,               // _KW_JECXZ
    _KW_JG = 429,                  // _KW_JG
    _KW_JGE = 430,                 // _KW_JGE
    _KW_JL = 431,                  // _KW_JL
    _KW_JLE = 432,                 // _KW_JLE
    _KW_JMP = 433,                 // _KW_JMP
    _KW_JNA = 434,                 // _KW_JNA
    _KW_JNAE = 435,                // _KW_JNAE
    _KW_JNB = 436,                 // _KW_JNB
    _KW_JNBE = 437,                // _KW_JNBE
    _KW_JNC = 438,                 // _KW_JNC
    _KW_JNE = 439,                 // _KW_JNE
    _KW_JNG = 440,                 // _KW_JNG
    _KW_JNGE = 441,                // _KW_JNGE
    _KW_JNL = 442,                 // _KW_JNL
    _KW_JNLE = 443,                // _KW_JNLE
    _KW_JNO = 444,                 // _KW_JNO
    _KW_JNP = 445,                 // _KW_JNP
    _KW_JNS = 446,                 // _KW_JNS
    _KW_JNZ = 447,                 // _KW_JNZ
    ...
    _KW_JS = 452,                  // _KW_JS
    _KW_JZ = 453,                  // _KW_JZ
    _KW_LAHF = 454,                // _KW_LAHF
    _KW_LAR = 455,                 // _KW_LAR
    _KW_LDS = 456,                 // _KW_LDS
    _KW_LEA = 457,                 // _KW_LEA
    _KW_LEAVE = 458,               // _KW_LEAVE
    _KW_LES = 459,                 // _KW_LES
    _KW_LFS = 460,                 // _KW_LFS
    _KW_LGDT = 461,                // _KW_LGDT
    _KW_LGS = 462,                 // _KW_LGS
    _KW_LIDT = 463,                // _KW_LIDT
    _KW_LLDT = 464,                // _KW_LLDT
    _KW_LMSW = 465,                // _KW_LMSW
    _KW_LOCK = 466,                // _KW_LOCK
    _KW_LODSB = 467,               // _KW_LODSB
    _KW_LODSD = 468,               // _KW_LODSD
    _KW_LODSW = 469,               // _KW_LODSW
    _KW_LOOP = 470,                // _KW_LOOP
    _KW_LOOPE = 471,               // _KW_LOOPE
    _KW_LOOPNE = 472,              // _KW_LOOPNE
    _KW_LOOPNZ = 473,              // _KW_LOOPNZ
    _KW_LOOPZ = 474,               // _KW_LOOPZ
    _KW_LSL = 475,                 // _KW_LSL
    _KW_LSS = 476,                 // _KW_LSS
    _KW_LTR = 477,                 // _KW_LTR
    _KW_MOV = 478,                 // _KW_MOV
    _KW_MOVSB = 479,               // _KW_MOVSB
    _KW_MOVSD = 480,               // _KW_MOVSD
    _KW_MOVSW = 481,               // _KW_MOVSW
    _KW_MOVSX = 482,               // _KW_MOVSX
    _KW_MOVZX = 483,               // _KW_MOVZX
    _KW_MUL = 484,                 // _KW_MUL
    _KW_NEG = 485,                 // _KW_NEG
    _KW_NOP = 486,                 // _KW_NOP
    _KW_NOT = 487,                 // _KW_NOT
    _KW_OPTIMIZE = 488,            // _KW_OPTIMIZE
    _KW_OR = 489,                  // _KW_OR
    _KW_ORG = 490,                 // _KW_ORG
    _KW_OUT = 491,                 // _KW_OUT
    _KW_OUTSB = 492,               // _KW_OUTSB
    _KW_OUTSD = 493,               // _KW_OUTSD
    _KW_OUTSW = 494,               // _KW_OUTSW
    _KW_PADDING = 495,             // _KW_PADDING
    _KW_PADSET = 496,              // _KW_PADSET
    _KW_POP = 497,                 // _KW_POP
    _KW_POPA = 498,                // _KW_POPA
    _KW_POPAD = 499,               // _KW_POPAD
    _KW_POPAW = 500,               // _KW_POPAW
    _KW_POPF = 501,                // _KW_POPF
    _KW_POPFD = 502,               // _KW_POPFD
    _KW_POPFW = 503,               // _KW_POPFW
    _KW_PUSH = 504,                // _KW_PUSH
    _KW_PUSHA = 505,               // _KW_PUSHA
    _KW_PUSHAD = 506,              // _KW_PUSHAD
    _KW_PUSHAW = 507,              // _KW_PUSHAW
    _KW_PUSHD = 508,               // _KW_PUSHD
    _KW_PUSHF = 509,               // _KW_PUSHF
    _KW_PUSHFD = 510,              // _KW_PUSHFD
    _KW_PUSHFW = 511,              // _KW_PUSHFW
    _KW_RCL = 512,                 // _KW_RCL
    _KW_RCR = 513,                 // _KW_RCR
    _KW_RDMSR = 514,               // _KW_RDMSR
    _KW_RDPMC = 515,               // _KW_RDPMC
    _KW_REP = 516,                 // _KW_REP
    _KW_REPE = 517,                // _KW_REPE
    _KW_REPNE = 518,               // _KW_REPNE
    _KW_REPNZ = 519,               // _KW_REPNZ
    _KW_REPZ = 520,                // _KW_REPZ
    _KW_RESB = 521,                // _KW_RESB
    _KW_RESD = 522,                // _KW_RESD
    _KW_RESQ = 523,                // _KW_RESQ
    _KW_REST = 524,                // _KW_REST
    _KW_RESW = 525,                // _KW_RESW
    _KW_RET = 526,                 // _KW_RET
    _KW_RETF = 527,                // _KW_RETF
    _KW_RETN = 528,                // _KW_RETN
    _KW_ROL = 529,                 // _KW_ROL
    _KW_ROR = 530,                 // _KW_ROR
    _KW_RSM = 531,                 // _KW_RSM
    _KW_SAHF = 532,                // _KW_SAHF
    _KW_SAL = 533,                 // _KW_SAL
    _KW_SAR = 534,                 // _KW_SAR
    _KW_SBB = 535,                 // _KW_SBB
    _KW_SCASB = 536,               // _KW_SCASB
    _KW_SCASD = 537,               // _KW_SCASD
    _KW_SCASW = 538,               // _KW_SCASW
    _KW_SECTION = 539,             // _KW_SECTION
    _KW_SETA = 540,                // _KW_SETA
    _KW_SETAE = 541,               // _KW_SETAE
    _KW_SETB = 542,                // _KW_SETB
    _KW_SETBE = 543,               // _KW_SETBE
    _KW_SETC = 544,                // _KW_SETC
    _KW_SETE = 545,                // _KW_SETE
    _KW_SETG = 546,                // _KW_SETG
    _KW_SETGE = 547,               // _KW_SETGE
    _KW_SETL = 548,                // _KW_SETL
    _KW_SETLE = 549,               // _KW_SETLE
    _KW_SETNA = 550,               // _KW_SETNA
    _KW_SETNAE = 551,              // _KW_SETNAE
    _KW_SETNB = 552,               // _KW_SETNB
    _KW_SETNBE = 553,              // _KW_SETNBE
    _KW_SETNC = 554,               // _KW_SETNC
    _KW_SETNE = 555,               // _KW_SETNE
    _KW_SETNG = 556,               // _KW_SETNG
    _KW_SETNGE = 557,              // _KW_SETNGE
    _KW_SETNL = 558,               // _KW_SETNL
    _KW_SETNLE = 559,              // _KW_SETNLE
    _KW_SETNO = 560,               // _KW_SETNO
    _KW_SETNP = 561,               // _KW_SETNP
    _KW_SETNS = 562,               // _KW_SETNS
    _KW_SETNZ = 563,               // _KW_SETNZ
    _KW_SETO = 564,                // _KW_SETO
    _KW_SETP = 565,                // _KW_SETP
    _KW_SETPE = 566,               // _KW_SETPE
    _KW_SETPO = 567,               // _KW_SETPO
    _KW_SETS = 568,                // _KW_SETS
    _KW_SETZ = 569,                // _KW_SETZ
    _KW_SGDT = 570,                // _KW_SGDT
    _KW_SHL = 571,                 // _KW_SHL
    _KW_SHLD = 572,                // _KW_SHLD
    _KW_SHR = 573,                 // _KW_SHR
    _KW_SHRD = 574,                // _KW_SHRD
    _KW_SIDT = 575,                // _KW_SIDT
    _KW_SLDT = 576,                // _KW_SLDT
    _KW_SMSW = 577,                // _KW_SMSW
    _KW_STC = 578,                 // _KW_STC
    _KW_STD = 579,                 // _KW_STD
    _KW_STI = 580,                 // _KW_STI
    _KW_STOSB = 581,               // _KW_STOSB
    _KW_STOSD = 582,               // _KW_STOSD
    _KW_STOSW = 583,               // _KW_STOSW
    _KW_STR = 584,                 // _KW_STR
    _KW_SUB = 585,                 // _KW_SUB
    _KW_TEST = 586,                // _KW_TEST
    _KW_TIMES = 587,               // _KW_TIMES
    _KW_UD2 = 588,                 // _KW_UD2
    _KW_VERR = 589,                // _KW_VERR
    _KW_VERW = 590,                // _KW_VERW
    _KW_WAIT = 591,                // _KW_WAIT
    _KW_WBINVD = 592,              // _KW_WBINVD
    _KW_WORD = 593,                // _KW_WORD
    _KW_WRMSR = 594,               // _KW_WRMSR
    _KW_XADD = 595,                // _KW_XADD
    _KW_XCHG = 596,                // _KW_XCHG
    _KW_XLATB = 597,               // _KW_XLATB
    _KW_XOR = 598,                 // _KW_XOR
    _LBRACK = 599,                 // _LBRACK
    _RBRACK = 600,                 // _RBRACK
    T_Hex = 601,                   // T_Hex
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S__SLASH = 9,                            // _SLASH
        S__COLON = 10,                           // _COLON
        S__KW_AAA = 11,                          // _KW_AAA
        S__KW_AAD = 12,                          // _KW_AAD
        S__KW_AAM = 13,                          // _KW_AAM
        S__KW_AAS = 14,                          // _KW_AAS
        S__KW_ABSOLUTE = 15,                     // _KW_ABSOLUTE
        S__KW_ADC = 16,                          // _KW_ADC
        S__KW_ADD = 17,                          // _KW_ADD
        S__KW_ALIGN = 18,                        // _KW_ALIGN
        S__KW_ALIGNB = 19,                       // _KW_ALIGNB
        S__KW_AND = 20,                          // _KW_AND
        S__KW_ARPL = 21,                         // _KW_ARPL
        S__KW_BITS = 22,                         // _KW_BITS
        S__KW_BOUND = 23,                        // _KW_BOUND
        S__KW_BSF = 24,                          // _KW_BSF
        S__KW_BSR = 25,                          // _KW_BSR
        S__KW_BSWAP = 26,                        // _KW_BSWAP
        S__KW_BT = 27,                           // _KW_BT
        S__KW_BTC = 28,                          // _KW_BTC
        S__KW_BTR = 29,                          // _KW_BTR
        S__KW_BTS = 30,                          // _KW_BTS
        S__KW_BYTE = 31,                         // _KW_BYTE
        S__KW_CALL = 32,                         // _KW_CALL
        S__KW_CBW = 33,                          // _KW_CBW
        S__KW_CDQ = 34,                          // _KW_CDQ
        S__KW_CLC = 35,                          // _KW_CLC
        S__KW_CLD = 36,                          // _KW_CLD
        S__KW_CLI = 37,                          // _KW_CLI
        S__KW_CLTS = 38,                         // _KW_CLTS
        S__KW_CMC = 39,                          // _KW_CMC
        S__KW_CMP = 40,                          // _KW_CMP
        S__KW_CMPSB = 41,                        // _KW_CMPSB
        S__KW_CMPSD = 42,                        // _KW_CMPSD
        S__KW_CMPSW = 43,                        // _KW_CMPSW
        S__KW_CMPXCHG = 44,                      // _KW_CMPXCHG
        S__KW_CPUID = 45,                        // _KW_CPUID
        S__KW_CWD = 46,                          // _KW_CWD
        S__KW_CWDE = 47,                         // _KW_CWDE
        S__KW_DAA = 48,                          // _KW_DAA
        S__KW_DAS = 49,                          // _KW_DAS
        S__KW_DB = 50,                           // _KW_DB
        S__KW_DD = 51,                           // _KW_DD
        S__KW_DEC = 52,                          // _KW_DEC
        S__KW_DIV = 53,                          // _KW_DIV
        S__KW_DQ = 54,                           // _KW_DQ
        S__KW_DT = 55,                           // _KW_DT
        S__KW_DW = 56,                           // _KW_DW
        S__KW_DWORD = 57,                        // _KW_DWORD
        S__KW_END = 58,                          // _KW_END
        S__KW_ENTER = 59,                        // _KW_ENTER
        S__KW_EQU = 60,                          // _KW_EQU
        S__KW_EXTERN = 61,                       // _KW_EXTERN
        S__KW_F2XM1 = 62,                        // _KW_F2XM1
        S__KW_FABS = 63,                         // _KW_FABS
        S__KW_FADD = 64,                         // _KW_FADD
        S__KW_FADDP = 65,                        // _KW_FADDP
        S__KW_FBLD = 66,                         // _KW_FBLD
        S__KW_FBSTP = 67,                        // _KW_FBSTP
        S__KW_FCHS = 68,                         // _KW_FCHS
        S__KW_FCLEX = 69,                        // _KW_FCLEX
        S__KW_FCOM = 70,                         // _KW_FCOM
        S__KW_FCOMP = 71,                        // _KW_FCOMP
        S__KW_FCOMPP = 72,                       // _KW_FCOMPP
        S__KW_FCOS = 73,                         // _KW_FCOS
        S__KW_FDECSTP = 74,                      // _KW_FDECSTP
        S__KW_FDISI = 75,                        // _KW_FDISI
        S__KW_FDIV = 76,                         // _KW_FDIV
        S__KW_FDIVP = 77,                        // _KW_FDIVP
        S__KW_FDIVR = 78,                        // _KW_FDIVR
        S__KW_FDIVRP = 79,                       // _KW_FDIVRP
        S__KW_FENI = 80,                         // _KW_FENI
        S__KW_FFREE = 81,                        // _KW_FFREE
        S__KW_FIADD = 82,                        // _KW_FIADD
        S__KW_FICOM = 83,                        // _KW_FICOM
        S__KW_FICOMP = 84,                       // _KW_FICOMP
        S__KW_FIDIV = 85,                        // _KW_FIDIV
        S__KW_FIDIVR = 86,                       // _KW_FIDIVR
        S__KW_FILD = 87,                         // _KW_FILD
        S__KW_FILE = 88,                         // _KW_FILE
        S__KW_FIMUL = 89,                        // _KW_FIMUL
        S__KW_FINCSTP = 90,                      // _KW_FINCSTP
        S__KW_FINIT = 91,                        // _KW_FINIT
        S__KW_FIST = 92,                         // _KW_FIST
        S__KW_FISTP = 93,                        // _KW_FISTP
        S__KW_FISUB = 94,                        // _KW_FISUB
        S__KW_FISUBR = 95,                       // _KW_FISUBR
        S__KW_FLD = 96,                          // _KW_FLD
        S__KW_FLD1 = 97,                         // _KW_FLD1
        S__KW_FLDCW = 98,                        // _KW_FLDCW
        S__KW_FLDENV = 99,                       // _KW_FLDENV
        S__KW_FLDL2E = 100,                      // _KW_FLDL2E
        S__KW_FLDL2T = 101,                      // _KW_FLDL2T
        S__KW_FLDLG2 = 102,                      // _KW_FLDLG2
        S__KW_FLDLN2 = 103,                      // _KW_FLDLN2
        S__KW_FLDPI = 104,                       // _KW_FLDPI
        S__KW_FLDZ = 105,                        // _KW_FLDZ
        S__KW_FMUL = 106,                        // _KW_FMUL
        S__KW_FMULP = 107,                       // _KW_FMULP
        S__KW_FNCLEX = 108,                      // _KW_FNCLEX
        S__KW_FNDISI = 109,                      // _KW_FNDISI
        S__KW_FNENI = 110,                       // _KW_FNENI
        S__KW_FNINIT = 111,                      // _KW_FNINIT
        S__KW_FNOP = 112,                        // _KW_FNOP
        S__KW_FNSAVE = 113,                      // _KW_FNSAVE
        S__KW_FNSTCW = 114,                      // _KW_FNSTCW
        S__KW_FNSTENV = 115,                     // _KW_FNSTENV
        S__KW_FNSTSW = 116,                      // _KW_FNSTSW
        S__KW_FORMAT = 117,                      // _KW_FORMAT
        S__KW_FPATAN = 118,                      // _KW_FPATAN
        S__KW_FPREM = 119,                       // _KW_FPREM
        S__KW_FPREM1 = 120,                      // _KW_FPREM1
        S__KW_FPTAN = 121,                       // _KW_FPTAN
        S__KW_FRNDINT = 122,                     // _KW_FRNDINT
        S__KW_FRSTOR = 123,                      // _KW_FRSTOR
        S__KW_FSAVE = 124,                       // _KW_FSAVE
        S__KW_FSCALE = 125,                      // _KW_FSCALE
        S__KW_FSETPM = 126,                      // _KW_FSETPM
        S__KW_FSIN = 127,                        // _KW_FSIN
        S__KW_FSINCOS = 128,                     // _KW_FSINCOS
        S__KW_FSQRT = 129,                       // _KW_FSQRT
        S__KW_FST = 130,                         // _KW_FST
        S__KW_FSTCW = 131,                       // _KW_FSTCW
        S__KW_FSTENV = 132,                      // _KW_FSTENV
        S__KW_FSTP = 133,                        // _KW_FSTP
        S__KW_FSTSW = 134,                       // _KW_FSTSW
        S__KW_FSUB = 135,                        // _KW_FSUB
        S__KW_FSUBP = 136,                       // _KW_FSUBP
        S__KW_FSUBR = 137,                       // _KW_FSUBR
        S__KW_FSUBRP = 138,                      // _KW_FSUBRP
        S__KW_FTST = 139,                        // _KW_FTST
        S__KW_FUCOM = 140,                       // _KW_FUCOM
        S__KW_FUCOMP = 141,                      // _KW_FUCOMP
        S__KW_FUCOMPP = 142,                     // _KW_FUCOMPP
        S__KW_FXAM = 143,                        // _KW_FXAM
        S__KW_FXCH = 144,                        // _KW_FXCH
        S__KW_FXTRACT = 145,                     // _KW_FXTRACT
        S__KW_FYL2X = 146,                       // _KW_FYL2X
        S__KW_FYL2XP1 = 147,                     // _KW_FYL2XP1
        S__KW_HLT = 148,                         // _KW_HLT
        S__KW_IDIV = 149,                        // _KW_IDIV
        S__KW_IMUL = 150,                        // _KW_IMUL
        S__KW_IN = 151,                          // _KW_IN
        S__KW_INC = 152,                         // _KW_INC
        S__KW_INCO = 153,                        // _KW_INCO
        S__KW_INSB = 154,                        // _KW_INSB
        S__KW_INSD = 155,                        // _KW_INSD
        S__KW_INSTRSET = 156,                    // _KW_INSTRSET
        S__KW_INSW = 157,                        // _KW_INSW
        S__KW_INT = 158,                         // _KW_INT
        S__KW_INT3 = 159,                        // _KW_INT3
        S__KW_INTO = 160,                        // _KW_INTO
        S__KW_INVD = 161,                        // _KW_INVD
        S__KW_INVLPG = 162,                      // _KW_INVLPG
        S__KW_IRET = 163,                        // _KW_IRET
        S__KW_IRETD = 164,                       // _KW_IRETD
        S__KW_IRETW = 165,                       // _KW_IRETW
        S__KW_JA = 166,                          // _KW_JA
        S__KW_JAE = 167,                         // _KW_JAE
        S__KW_JB = 168,                          // _KW_JB
        S__KW_JBE = 169,                         // _KW_JBE
        S__KW_JC = 170,                          // _KW_JC
        S__KW_JCXZ = 171,                        // _KW_JCXZ
        S__KW_JE = 172,                          // _KW_JE
        S__KW_JECXZ = 173,                       // _KW_JECXZ
        S__KW_JG = 174,                          // _KW_JG
        S__KW_JGE = 175,                         // _KW_JGE
        S__KW_JL = 176,                          // _KW_JL
        S__KW_JLE = 177,                         // _KW_JLE
        S__KW_JMP = 178,                         // _KW_JMP
        S__KW_JNA = 179,                         // _KW_JNA
        S__KW_JNAE = 180,                        // _KW_JNAE
        S__KW_JNB = 181,                         // _KW_JNB
        S__KW_JNBE = 182,                        // _KW_JNBE
        S__KW_JNC = 183,                         // _KW_JNC
        S__KW_JNE = 184,                         // _KW_JNE
        S__KW_JNG = 185,                         // _KW_JNG
        S__KW_JNGE = 186,                        // _KW_JNGE
        S__KW_JNL = 187,                         // _KW_JNL
        S__KW_JNLE = 188,                        // _KW_JNLE
        S__KW_JNO = 189,                         // _KW_JNO
        S__KW_JNP = 190,                         // _KW_JNP
        S__KW_JNS = 191,                         // _KW_JNS
        S__KW_JNZ = 192,                         // _KW_JNZ
        S__KW_JO = 193,                          // _KW_JO
        S__KW_JP = 194,                          // _KW_JP
        S__KW_JPE = 195,                         // _KW_JPE
        S__KW_JPO = 196,                         // _KW_JPO
        S__KW_JS = 197,                          // _KW_JS
        S__KW_JZ = 198,                          // _KW_JZ
        S__KW_LAHF = 199,                        // _KW_LAHF
        S__KW_LAR = 200,                         // _KW_LAR
        S__KW_LDS = 201,                         // _KW_LDS
        S__KW_LEA = 202,                         // _KW_LEA
        S__KW_LEAVE = 203,                       // _KW_LEAVE
        S__KW_LES = 204,                         // _KW_LES
        S__KW_LFS = 205,                         // _KW_LFS
        S__KW_LGDT = 206,                        // _KW_LGDT
        S__KW_LGS = 207,                         // _KW_LGS
        S__KW_LIDT = 208,                        // _KW_LIDT
        S__KW_LLDT = 209,                        // _KW_LLDT
        S__KW_LMSW = 210,                        // _KW_LMSW
        S__KW_LOCK = 211,                        // _KW_LOCK
        S__KW_LODSB = 212,                       // _KW_LODSB
        S__KW_LODSD = 213,                       // _KW_LODSD
        S__KW_LODSW = 214,                       // _KW_LODSW
        S__KW_LOOP = 215,                        // _KW_LOOP
        S__KW_LOOPE = 216,                       // _KW_LOOPE
        S__KW_LOOPNE = 217,                      // _KW_LOOPNE
        S__KW_LOOPNZ = 218,                      // _KW_LOOPNZ
        S__KW_LOOPZ = 219,                       // _KW_LOOPZ
        S__KW_LSL = 220,                         // _KW_LSL
        S__KW_LSS = 221,                         // _KW_LSS
        S__KW_LTR = 222,                         // _KW_LTR
        S__KW_MOV = 223,                         // _KW_MOV
        S__KW_MOVSB = 224,                       // _KW_MOVSB
        S__KW_MOVSD = 225,                       // _KW_MOVSD
        S__KW_MOVSW = 226,                       // _KW_MOVSW
        S__KW_MOVSX = 227,                       // _KW_MOVSX
        S__KW_MOVZX = 228,                       // _KW_MOVZX
        S__KW_MUL = 229,                         // _KW_MUL
        S__KW_NEG = 230,                         // _KW_NEG
        S__KW_NOP = 231,                         // _KW_NOP
        S__KW_NOT = 232,                         // _KW_NOT
        S__KW_OPTIMIZE = 233,                    // _KW_OPTIMIZE
        S__KW_OR = 234,                          // _KW_OR
        S__KW_ORG = 235,                         // _KW_ORG
        S__KW_OUT = 236,                         // _KW_OUT
        S__KW_OUTSB = 237,                       // _KW_OUTSB
        S__KW_OUTSD = 238,                       // _KW_OUTSD
        S__KW_OUTSW = 239,                       // _KW_OUTSW
        S__KW_PADDING = 240,                     // _KW_PADDING
        S__KW_PADSET = 241,                      // _KW_PADSET
        S__KW_POP = 242,                         // _KW_POP
        S__KW_POPA = 243,                        // _KW_POPA
        S__KW_POPAD = 244,                       // _KW_POPAD
        S__KW_POPAW = 245,                       // _KW_POPAW
        S__KW_POPF = 246,                        // _KW_POPF
        S__KW_POPFD = 247,                       // _KW_POPFD
        S__KW_POPFW = 248,                       // _KW_POPFW
        S__KW_PUSH = 249,                        // _KW_PUSH
        S__KW_PUSHA = 250,                       // _KW_PUSHA
        S__KW_PUSHAD = 251,                      // _KW_PUSHAD
        S__KW_PUSHAW = 252,                      // _KW_PUSHAW
        S__KW_PUSHD = 253,                       // _KW_PUSHD
        S__KW_PUSHF = 254,                       // _KW_PUSHF
        S__KW_PUSHFD = 255,                      // _KW_PUSHFD
        S__KW_PUSHFW = 256,                      // _KW_PUSHFW
        S__KW_RCL = 257,                         // _KW_RCL
        S__KW_RCR = 258,                         // _KW_RCR
        S__KW_RDMSR = 259,                       // _KW_RDMSR
        S__KW_RDPMC = 260,                       // _KW_RDPMC
        S__KW_REP = 261,                         // _KW_REP
        S__KW_REPE = 262,                        // _KW_REPE
        S__KW_REPNE = 263,                       // _KW_REPNE
        S__KW_REPNZ = 264,                       // _KW_REPNZ
        S__KW_REPZ = 265,                        // _KW_REPZ
        S__KW_RESB = 266,                        // _KW_RESB
        S__KW_RESD = 267,                        // _KW_RESD
        S__KW_RESQ = 268,                        // _KW_RESQ
        S__KW_REST = 269,                        // _KW_REST
        S__KW_RESW = 270,                        // _KW_RESW
        S__KW_RET = 271,                         // _KW_RET
        S__KW_RETF = 272,                        // _KW_RETF
        S__KW_RETN = 273,                        // _KW_RETN
        S__KW_ROL = 274,                         // _KW_ROL
        S__KW_ROR = 275,                         // _KW_ROR
        S__KW_RSM = 276,                         // _KW_RSM
        S__KW_SAHF = 277,                        // _KW_SAHF
        S__KW_SAL = 278,                         // _KW_SAL
        S__KW_SAR = 279,                         // _KW_SAR
        S__KW_SBB = 280,                         // _KW_SBB
        S__KW_SCASB = 281,                       // _KW_SCASB
        S__KW_SCASD = 282,                       // _KW_SCASD
        S__KW_SCASW = 283,                       // _KW_SCASW
        S__KW_SECTION = 284,                     // _KW_SECTION
        S__KW_SETA = 285,                        // _KW_SETA
        S__KW_SETAE = 286,                       // _KW_SETAE
        S__KW_SETB = 287,                        // _KW_SETB
        S__KW_SETBE = 288,                       // _KW_SETBE
        S__KW_SETC = 289,                        // _KW_SETC
        S__KW_SETE = 290,                        // _KW_SETE
        S__KW_SETG = 291,                        // _KW_SETG
        S__KW_SETGE = 292,                       // _KW_SETGE
        S__KW_SETL = 293,                        // _KW_SETL
        S__KW_SETLE = 294,                       // _KW_SETLE
        S__KW_SETNA = 295,                       // _KW_SETNA
        S__KW_SETNAE = 296,                      // _KW_SETNAE
        S__KW_SETNB = 297,                       // _KW_SETNB
        S__KW_SETNBE = 298,                      // _KW_SETNBE
        S__KW_SETNC = 299,                       // _KW_SETNC
        S__KW_SETNE = 300,                       // _KW_SETNE
        S__KW_SETNG = 301,                       // _KW_SETNG
        S__KW_SETNGE = 302,                      // _KW_SETNGE
        S__KW_SETNL = 303,                       // _KW_SETNL
        S__KW_SETNLE = 304,                      // _KW_SETNLE
        S__KW_SETNO = 305,                       // _KW_SETNO
        S__KW_SETNP = 306,                       // _KW_SETNP
        S__KW_SETNS = 307,                       // _KW_SETNS
        S__KW_SETNZ = 308,                       // _KW_SETNZ
        S__KW_SETO = 309,                        // _KW_SETO
        S__KW_SETP = 310,                        // _KW_SETP
        S__KW_SETPE = 311,                       // _KW_SETPE
        S__KW_SETPO = 312,                       // _KW_SETPO
        S__KW_SETS = 313,                        // _KW_SETS
        S__KW_SETZ = 314,                        // _KW_SETZ
        S__KW_SGDT = 315,                        // _KW_SGDT
        S__KW_SHL = 316,                         // _KW_SHL
        S__KW_SHLD = 317,                        // _KW_SHLD
        S__KW_SHR = 318,                         // _KW_SHR
        S__KW_SHRD = 319,                        // _KW_SHRD
        S__KW_SIDT = 320,                        // _KW_SIDT
        S__KW_SLDT = 321,                        // _KW_SLDT
        S__KW_SMSW = 322,                        // _KW_SMSW
        S__KW_STC = 323,                         // _KW_STC
        S__KW_STD = 324,                         // _KW_STD
        S__KW_STI = 325,                         // _KW_STI
        S__KW_STOSB = 326,                       // _KW_STOSB
        S__KW_STOSD = 327,                       // _KW_STOSD
        S__KW_STOSW = 328,                       // _KW_STOSW
        S__KW_STR = 329,                         // _KW_STR
        S__KW_SUB = 330,                         // _KW_SUB
        S__KW_TEST = 331,                        // _KW_TEST
        S__KW_TIMES = 332,                       // _KW_TIMES
        S__KW_UD2 = 333,                         // _KW_UD2
        S__KW_VERR = 334,                        // _KW_VERR
        S__KW_VERW = 335,                        // _KW_VERW
        S__KW_WAIT = 336,                        // _KW_WAIT
        S__KW_WBINVD = 337,                      // _KW_WBINVD
        S__KW_WORD = 338,                        // _KW_WORD
        S__KW_WRMSR = 339,                       // _KW_WRMSR
        S__KW_XADD = 340,                        // _KW_XADD
        S__KW_XCHG = 341,                        // _KW_XCHG
        S__KW_XLATB = 342,                       // _KW_XLATB
        S__KW_XOR = 343,                         // _KW_XOR
        S__LBRACK = 344,                         // _LBRACK
        S__RBRACK = 345,                         // _RBRACK
        S_T_Hex = 346,                           // T_Hex
        S_T_Label = 347,                         // T_Label
        S__STRING_ = 348,                        // _STRING_
        S__INTEGER_ = 349,                       // _INTEGER_
        S__IDENT_ = 350,                         // _IDENT_
        S_YYACCEPT = 351,                        // $accept
        S_Program = 352,                         // Program
        S_ListStatement = 353,                   // ListStatement
        S_Statement = 354,                       // Statement
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make__IDENT_ (std::string v, location_type l)
      {
        return symbol_type (token::_IDENT_, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make__IDENT_ (const std::string& v, const location_type& l)
      {
        return symbol_type (token::_IDENT_, v, l);
      }
#endif
  ...
  private:
    ...
    enum
    {
      yylast_ = 681,     ///< Last index in yytable_.
