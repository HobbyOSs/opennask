...
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdAdc, 0x15>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdAdd, 0x05>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdAnd, 0x25>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdCmp, 0x3d>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdOr,  0x0d>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdSbb, 0x1d>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdSub, 0x2d>(std::vector<TParaToken>& mnemonic_args);
template void FrontEnd::processEmitAdd<asmjit::x86::Inst::kIdXor, 0x35>(std::vector<TParaToken>& mnemonic_args);
