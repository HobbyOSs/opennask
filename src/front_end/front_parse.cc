...
void FrontEnd::visitMnemonicStmt(MnemonicStmt *mnemonic_stmt){
    ...
    funcs_type funcs {
        // 引数なしのオペコード
        std::make_pair("OpcodesAAA", std::bind(&FrontEnd::processEmit<Inst::kIdAaa>, this)),
        std::make_pair("OpcodesAAS", std::bind(&FrontEnd::processEmit<Inst::kIdAas>, this)),
        std::make_pair("OpcodesCBW", std::bind(&FrontEnd::processEmit<Inst::kIdCbw>, this)),
        std::make_pair("OpcodesCDQ", std::bind(&FrontEnd::processEmit<Inst::kIdCdq>, this)),
        std::make_pair("OpcodesCLC", std::bind(&FrontEnd::processEmit<Inst::kIdClc>, this)),
        std::make_pair("OpcodesCLD", std::bind(&FrontEnd::processEmit<Inst::kIdCld>, this)),
        std::make_pair("OpcodesCLI", std::bind(&FrontEnd::processEmit<Inst::kIdCli>, this)),
        std::make_pair("OpcodesCLTS", std::bind(&FrontEnd::processEmit<Inst::kIdClts>, this)),
        std::make_pair("OpcodesCMC", std::bind(&FrontEnd::processEmit<Inst::kIdCmc>, this)),
        //std::make_pair("OpcodesCMPSB", std::bind(&FrontEnd::processEmit<Inst::kIdCmpsb>, this)),
        //std::make_pair("OpcodesCMPSD", std::bind(&FrontEnd::processEmit<Inst::kIdCmpsd>, this)),
        //std::make_pair("OpcodesCMPSW", std::bind(&FrontEnd::processEmit<Inst::kIdCmpsw>, this)),
        std::make_pair("OpcodesCWD", std::bind(&FrontEnd::processEmit<Inst::kIdCwd>, this)),
        std::make_pair("OpcodesCWDE", std::bind(&FrontEnd::processEmit<Inst::kIdCwde>, this)),
        std::make_pair("OpcodesDAA", std::bind(&FrontEnd::processEmit<Inst::kIdDaa>, this)),
        std::make_pair("OpcodesDAS", std::bind(&FrontEnd::processEmit<Inst::kIdDas>, this)),
        std::make_pair("OpcodesF2XM1", std::bind(&FrontEnd::processEmit<Inst::kIdF2xm1>, this)),
        std::make_pair("OpcodesFABS", std::bind(&FrontEnd::processEmit<Inst::kIdFabs>, this)),
        std::make_pair("OpcodesFCHS", std::bind(&FrontEnd::processEmit<Inst::kIdFchs>, this)),
        std::make_pair("OpcodesFCLEX", std::bind(&FrontEnd::processEmit<Inst::kIdFclex>, this)),
        std::make_pair("OpcodesFCOMPP", std::bind(&FrontEnd::processEmit<Inst::kIdFcompp>, this)),
        std::make_pair("OpcodesFCOS", std::bind(&FrontEnd::processEmit<Inst::kIdFcos>, this)),
        std::make_pair("OpcodesFDECSTP", std::bind(&FrontEnd::processEmit<Inst::kIdFdecstp>, this)),
        //std::make_pair("OpcodesFDISI", std::bind(&FrontEnd::processEmit<Inst::kIdFdisi>, this)),
        //std::make_pair("OpcodesFENI", std::bind(&FrontEnd::processEmit<Inst::kIdFeni>, this)),
        std::make_pair("OpcodesFINCSTP", std::bind(&FrontEnd::processEmit<Inst::kIdFincstp>, this)),
        std::make_pair("OpcodesFINIT", std::bind(&FrontEnd::processEmit<Inst::kIdFinit>, this)),
        std::make_pair("OpcodesFLD1", std::bind(&FrontEnd::processEmit<Inst::kIdFld1>, this)),
        std::make_pair("OpcodesFLDL2E", std::bind(&FrontEnd::processEmit<Inst::kIdFldl2e>, this)),
        std::make_pair("OpcodesFLDL2T", std::bind(&FrontEnd::processEmit<Inst::kIdFldl2t>, this)),
        std::make_pair("OpcodesFLDLG2", std::bind(&FrontEnd::processEmit<Inst::kIdFldlg2>, this)),
        std::make_pair("OpcodesFLDLN2", std::bind(&FrontEnd::processEmit<Inst::kIdFldln2>, this)),
        std::make_pair("OpcodesFLDPI", std::bind(&FrontEnd::processEmit<Inst::kIdFldpi>, this)),
        std::make_pair("OpcodesFLDZ", std::bind(&FrontEnd::processEmit<Inst::kIdFldz>, this)),
        std::make_pair("OpcodesFNCLEX", std::bind(&FrontEnd::processEmit<Inst::kIdFnclex>, this)),
        //std::make_pair("OpcodesFNDISI", std::bind(&FrontEnd::processEmit<Inst::kIdFndisi>, this)),
        //std::make_pair("OpcodesFNENI", std::bind(&FrontEnd::processEmit<Inst::kIdFneni>, this)),
        std::make_pair("OpcodesFNINIT", std::bind(&FrontEnd::processEmit<Inst::kIdFninit>, this)),
        std::make_pair("OpcodesFNOP", std::bind(&FrontEnd::processEmit<Inst::kIdFnop>, this)),
        std::make_pair("OpcodesFPATAN", std::bind(&FrontEnd::processEmit<Inst::kIdFpatan>, this)),
        std::make_pair("OpcodesFPTAN", std::bind(&FrontEnd::processEmit<Inst::kIdFptan>, this)),
        std::make_pair("OpcodesFPREM", std::bind(&FrontEnd::processEmit<Inst::kIdFprem>, this)),
        std::make_pair("OpcodesFPREM1", std::bind(&FrontEnd::processEmit<Inst::kIdFprem1>, this)),
        std::make_pair("OpcodesFRNDINT", std::bind(&FrontEnd::processEmit<Inst::kIdFrndint>, this)),
        std::make_pair("OpcodesFSCALE", std::bind(&FrontEnd::processEmit<Inst::kIdFscale>, this)),
        //std::make_pair("OpcodesFSETPM", std::bind(&FrontEnd::processEmit<Inst::kIdFsetpm>, this)),
        std::make_pair("OpcodesFSIN", std::bind(&FrontEnd::processEmit<Inst::kIdFsin>, this)),
        std::make_pair("OpcodesFSINCOS", std::bind(&FrontEnd::processEmit<Inst::kIdFsincos>, this)),
        std::make_pair("OpcodesFSQRT", std::bind(&FrontEnd::processEmit<Inst::kIdFsqrt>, this)),
        std::make_pair("OpcodesFTST", std::bind(&FrontEnd::processEmit<Inst::kIdFtst>, this)),
        std::make_pair("OpcodesFUCOMPP", std::bind(&FrontEnd::processEmit<Inst::kIdFucompp>, this)),
        std::make_pair("OpcodesFXAM", std::bind(&FrontEnd::processEmit<Inst::kIdFxam>, this)),
        std::make_pair("OpcodesFXTRACT", std::bind(&FrontEnd::processEmit<Inst::kIdFxtract>, this)),
        std::make_pair("OpcodesFYL2X", std::bind(&FrontEnd::processEmit<Inst::kIdFyl2x>, this)),
        std::make_pair("OpcodesFYL2XP1", std::bind(&FrontEnd::processEmit<Inst::kIdFyl2xp1>, this)),
        std::make_pair("OpcodesHLT", std::bind(&FrontEnd::processEmit<Inst::kIdHlt>, this)),
        //std::make_pair("OpcodesINSB", std::bind(&FrontEnd::processEmit<Inst::kIdInsb>, this)),
        //std::make_pair("OpcodesINSD", std::bind(&FrontEnd::processEmit<Inst::kIdInsd>, this)),
        //std::make_pair("OpcodesINSW", std::bind(&FrontEnd::processEmit<Inst::kIdInsw>, this)),
        std::make_pair("OpcodesINT3", std::bind(&FrontEnd::processEmit<Inst::kIdInt3>, this)),
        std::make_pair("OpcodesINTO", std::bind(&FrontEnd::processEmit<Inst::kIdInto>, this)),
        std::make_pair("OpcodesINVD", std::bind(&FrontEnd::processEmit<Inst::kIdInvd>, this)),
        std::make_pair("OpcodesIRET", std::bind(&FrontEnd::processEmit<Inst::kIdIret>, this)),
        std::make_pair("OpcodesIRETD", std::bind(&FrontEnd::processEmit<Inst::kIdIretd>, this)),
        //std::make_pair("OpcodesIRETW", std::bind(&FrontEnd::processEmit<Inst::kIdIretw>, this)),
        std::make_pair("OpcodesLAHF", std::bind(&FrontEnd::processEmit<Inst::kIdLahf>, this)),
        std::make_pair("OpcodesLEAVE", std::bind(&FrontEnd::processEmit<Inst::kIdLeave>, this)),
        //std::make_pair("OpcodesLODSB", std::bind(&FrontEnd::processEmit<Inst::kIdLodsb>, this)),
        //std::make_pair("OpcodesLODSD", std::bind(&FrontEnd::processEmit<Inst::kIdLodsd>, this)),
        //std::make_pair("OpcodesLODSW", std::bind(&FrontEnd::processEmit<Inst::kIdLodsw>, this)),
        //std::make_pair("OpcodesMOVSB", std::bind(&FrontEnd::processEmit<Inst::kIdMovsb>, this)),
        std::make_pair("OpcodesMOVSD", std::bind(&FrontEnd::processEmit<Inst::kIdMovsd>, this)),
        //std::make_pair("OpcodesMOVSW", std::bind(&FrontEnd::processEmit<Inst::kIdMovsw>, this)),
        std::make_pair("OpcodesNOP", std::bind(&FrontEnd::processEmit<Inst::kIdNop>, this)),
        //std::make_pair("OpcodesOUTSB", std::bind(&FrontEnd::processEmit<Inst::kIdOutsb>, this)),
        //std::make_pair("OpcodesOUTSD", std::bind(&FrontEnd::processEmit<Inst::kIdOutsd>, this)),
        //std::make_pair("OpcodesOUTSW", std::bind(&FrontEnd::processEmit<Inst::kIdOutsw>, this)),
        std::make_pair("OpcodesPOPA", std::bind(&FrontEnd::processEmit<Inst::kIdPopa>, this)),
        std::make_pair("OpcodesPOPAD", std::bind(&FrontEnd::processEmit<Inst::kIdPopad>, this)),
        //std::make_pair("OpcodesPOPAW", std::bind(&FrontEnd::processEmit<Inst::kIdPopaw>, this)),
        std::make_pair("OpcodesPOPF", std::bind(&FrontEnd::processEmit<Inst::kIdPopf>, this)),
        std::make_pair("OpcodesPOPFD", std::bind(&FrontEnd::processEmit<Inst::kIdPopfd>, this)),
        //std::make_pair("OpcodesPOPFW", std::bind(&FrontEnd::processEmit<Inst::kIdPopfw>, this)),
        std::make_pair("OpcodesPUSHA", std::bind(&FrontEnd::processEmit<Inst::kIdPusha>, this)),
        std::make_pair("OpcodesPUSHAD", std::bind(&FrontEnd::processEmit<Inst::kIdPushad>, this)),
        //std::make_pair("OpcodesPUSHAW", std::bind(&FrontEnd::processEmit<Inst::kIdPushaw>, this)),
        std::make_pair("OpcodesPUSHF", std::bind(&FrontEnd::processEmit<Inst::kIdPushf>, this)),
        std::make_pair("OpcodesPUSHFD", std::bind(&FrontEnd::processEmit<Inst::kIdPushfd>, this)),
        //std::make_pair("OpcodesPUSHFW", std::bind(&FrontEnd::processEmit<Inst::kIdPushfw>, this)),
        std::make_pair("OpcodesSAHF", std::bind(&FrontEnd::processEmit<Inst::kIdSahf>, this)),
        //std::make_pair("OpcodesSCASB", std::bind(&FrontEnd::processEmit<Inst::kIdScasb>, this)),
        //std::make_pair("OpcodesSCASD", std::bind(&FrontEnd::processEmit<Inst::kIdScasd>, this)),
        //std::make_pair("OpcodesSCASW", std::bind(&FrontEnd::processEmit<Inst::kIdScasw>, this)),
        std::make_pair("OpcodesSTC", std::bind(&FrontEnd::processEmit<Inst::kIdStc>, this)),
        std::make_pair("OpcodesSTD", std::bind(&FrontEnd::processEmit<Inst::kIdStd>, this)),
        std::make_pair("OpcodesSTI", std::bind(&FrontEnd::processEmit<Inst::kIdSti>, this)),
        //std::make_pair("OpcodesSTOSB", std::bind(&FrontEnd::processEmit<Inst::kIdStosb>, this)),
        //std::make_pair("OpcodesSTOSD", std::bind(&FrontEnd::processEmit<Inst::kIdStosd>, this)),
        //std::make_pair("OpcodesSTOSW", std::bind(&FrontEnd::processEmit<Inst::kIdStosw>, this)),
        //std::make_pair("OpcodesWAIT", std::bind(&FrontEnd::processEmit<Inst::kIdWait>, this)),
        std::make_pair("OpcodesWBINVD", std::bind(&FrontEnd::processEmit<Inst::kIdWbinvd>, this)),
        std::make_pair("OpcodesXLATB", std::bind(&FrontEnd::processEmit<Inst::kIdXlatb>, this)),

        // JCC系オペコード
        std::make_pair("OpcodesJA", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJa>, this, _1)),
        std::make_pair("OpcodesJAE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJae>, this, _1)),
        std::make_pair("OpcodesJB", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJb>, this, _1)),
        std::make_pair("OpcodesJBE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJbe>, this, _1)),
        std::make_pair("OpcodesJC", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJc>, this, _1)),
        std::make_pair("OpcodesJE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJe>, this, _1)),
        std::make_pair("OpcodesJG", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJg>, this, _1)),
        std::make_pair("OpcodesJGE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJge>, this, _1)),
        std::make_pair("OpcodesJL", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJl>, this, _1)),
        std::make_pair("OpcodesJLE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJle>, this, _1)),
        std::make_pair("OpcodesJNA", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJna>, this, _1)),
        std::make_pair("OpcodesJNAE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnae>, this, _1)),
        std::make_pair("OpcodesJNB", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnb>, this, _1)),
        std::make_pair("OpcodesJNBE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnbe>, this, _1)),
        std::make_pair("OpcodesJNC", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnc>, this, _1)),
        std::make_pair("OpcodesJNE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJne>, this, _1)),
        std::make_pair("OpcodesJNG", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJng>, this, _1)),
        std::make_pair("OpcodesJNGE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnge>, this, _1)),
        std::make_pair("OpcodesJNL", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnl>, this, _1)),
        std::make_pair("OpcodesJNLE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnle>, this, _1)),
        std::make_pair("OpcodesJNO", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJno>, this, _1)),
        std::make_pair("OpcodesJNP", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnp>, this, _1)),
        std::make_pair("OpcodesJNS", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJns>, this, _1)),
        std::make_pair("OpcodesJNZ", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJnz>, this, _1)),
        std::make_pair("OpcodesJO", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJo>, this, _1)),
        std::make_pair("OpcodesJP", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJp>, this, _1)),
        std::make_pair("OpcodesJPE", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJpe>, this, _1)),
        std::make_pair("OpcodesJPO", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJpo>, this, _1)),
        std::make_pair("OpcodesJS", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJs>, this, _1)),
        std::make_pair("OpcodesJZ", std::bind(&FrontEnd::processEmitJcc<Inst::kIdJz>, this, _1)),
