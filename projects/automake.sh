...
do
    ...
    echo -e "#"                                            >> ${FILE_DIR}/Makefile.am
    echo -e ""                                             >> ${FILE_DIR}/Makefile.am
    echo -e "NASK = \$(top_builddir)/opennask\$(EXEEXT)"   >> ${FILE_DIR}/Makefile.am
    echo -e ""                                             >> ${FILE_DIR}/Makefile.am
    echo -e "all:"                                         >> ${FILE_DIR}/Makefile.am
    echo -e "\t\t\$(MAKE) ${BIN_NAME}.img"                 >> ${FILE_DIR}/Makefile.am
    echo -e ""                                             >> ${FILE_DIR}/Makefile.am
    echo -e "${BIN_NAME}.img : ${BIN_NAME}.nas"            >> ${FILE_DIR}/Makefile.am
    echo -e "\t\t\$(NASK) ${BIN_NAME}.nas ${BIN_NAME}.img" >> ${FILE_DIR}/Makefile.am
    echo -e ""                                             >> ${FILE_DIR}/Makefile.am
